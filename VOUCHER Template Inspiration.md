...
# Voucher templates – inspiration only

The voucher sheets on this page are just **one examples** of how your local circle's paper vouchers could look.

Feel free to:
- Use it as-is (print, cut, stamp, write serial numbers).
- Modify the design (add your circle's name, change colours, add a background).
- Create your own from scratch – as long as you keep the six core rules visible somewhere (demurrage, voluntary, forkable).

**Your vouchers do not need to be perfect.** Hand‑drawn on recycled paper is fine. The only essential elements are:
- Denomination (e.g., 20 units)
- Serial number (to prevent counterfeiting)
- Circle name or stamp (to show which community issued them)

<img width="1248" height="832" alt="SymbioForgeVocher8" src="https://github.com/user-attachments/assets/a2e5a898-43bd-4e57-b507-542c8164d5bb" />
<img width="1248" height="832" alt="SymbioForgeVoucher9" src="https://github.com/user-attachments/assets/e2be8b2a-3ac9-47e8-bb30-b7e8c78284f0" />
<img width="1248" height="832" alt="SymbioForgeVocuer5" src="https://github.com/user-attachments/assets/a8d1fb3f-4d6d-40f4-a7bc-bfde4cbbae90" />
<img width="1248" height="832" alt="SymbioForgeVocher6" src="https://github.com/user-attachments/assets/1cd7d105-2fbb-4575-ae97-d4af25eb8b48" />
<img width="1248" height="832" alt="SymbioForgeVoucher4" src="https://github.com/user-attachments/assets/b79ec278-547f-432e-a716-e2ea1e8116d2" />
<img width="1248" height="832" alt="SymbioforgeVoucher3" src="https://github.com/user-attachments/assets/c43c6363-7a73-4912-8d88-e93e131b9aa9" />
<img width="1248" height="832" alt="SymbioForgeVoucher2" src="https://github.com/user-attachments/assets/abbbfc55-8590-4186-8aff-9253cb74272d" />
<img width="1248" height="832" alt="SymbioForgeVoucher1" src="https://github.com/user-attachments/assets/82eb61dd-f0d3-4122-ad1b-89aaacfadadf" />
<img width="1248" height="832" alt="SymbioForgeVocuher7" src="https://github.com/user-attachments/assets/825a7558-117b-402a-8fda-088f26dd31b4" />
